...
class PixelBlast {
    ...
    init() {
        ...
        const isLight = document.documentElement.classList.contains('tema-claro') || document.body.classList.contains('tema-claro');
        // O canvas usa a mesma base neutra do tema claro para não criar uma faixa branca.
        const initialBg = isLight ? 0xdedede : 0x0d0d1f;
    ...
    watchColorChange() {
        const checkThemeAndColor = () => {
            ...
            const isLight = document.documentElement.classList.contains('tema-claro') || document.body.classList.contains('tema-claro');
            const targetBg = isLight ? 0xdedede : 0x0d0d1f;
            this.renderer.setClearColor(targetBg, 1);
        };
        ...
        setInterval(checkThemeAndColor, 1000);
    }
